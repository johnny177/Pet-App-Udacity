...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(currentPetUri == null){
            ...
            getSupportActionBar().setTitle(R.string.title_edit_a_pet);
    ...
    /**
     * get the data from the EdittextViews and adds it to the database
     */
    private void savePet(){
        ...
        if(TextUtils.isEmpty(breed)){
            values.put(PetEntry.COLUMN_PET_BREED, PetEntry.BREED_UNKNOWN);
        }else{
        ...
        if(currentPetUri == null){
            ...
            int rowAffected = getContentResolver().update(currentPetUri,
                    values,
                    null,
                    null);
            if(rowAffected != 0) {
                Toast.makeText(this, R.string.editor_updated_successfully,Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(this, R.string.editor_pet_update_failed,Toast.LENGTH_SHORT).show();
